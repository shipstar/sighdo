...
database_name = case Padrino.env
  when :development then 'sighdo_development'
  when :production  then 'sighdo_production'
  when :test        then 'sighdo_test'
end
...
#     sessions:
#       default:
#         database: sighdo_development
#         hosts:
#           - localhost:27017 
#   production:
#     sessions:
#       default:
#         database: sighdo_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: sighdo_test
#         hosts:
#           - localhost:27017
#
#
